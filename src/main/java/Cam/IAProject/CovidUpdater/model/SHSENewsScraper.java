...
public class SHSENewsScraper {
    ...
    public SHSENewsScraper(URL url){
        this.url = url;
        this.urlString = url.toString();
    }

    public SHSENewsScraper(String urlString) throws MalformedURLException {
    ...
    public ArrayList<SHSENews> getObjects() throws IOException {
        //create an ArrayList to return later of ENews Articles
        ArrayList<SHSENews> arr = new ArrayList<>();
        ...
        if(matcher.find()){
            ...
            //more regular expressions that gather title and date of each article and add them to ENews objects in the ArrayList above
            ...
            while(matcher.find()) {
                arr.add(new SHSENews(UUID.randomUUID(),"", matcher.group(), "https://www.issaquah.wednet.edu/news/ENews/archive"));
            }
            ...
            System.out.println("issue with parsing ENews article information from SHS Archives");
        }
        return arr;
    }
}